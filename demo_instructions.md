# Ralph Retina Demo Setup

## Task
Create a blindingly white Next.js application with a child-like sun drawing in the center to demonstrate the "need" for a dark mode.
...
2. Replace `app/page.tsx` with the code above.
3. Clean `app/globals.css` to only contain tailwind directives.
